  ...
  const workflow = [
    {
      ...
      title: "Develop",
      summary:
        "Compose React features with fast HMR and request forwarding ready by default.",
  ...
  const foundations = [
    {
      ...
      detail:
        "Vite + React workspace for rapid component delivery and API-connected flows.",
      anchor: "frontend/src/",
    },
    {
  ...
  return (
    <main className="studio-shell">
      <header className="studio-hero">
        <p className="studio-kicker">FASTAPI + REACT</p>
        <h1>Python API Product Baseline</h1>
        <p>
          A restrained, production-minded starter for teams shipping React
