function App() {
  const workflow = [
    {
      title: "Develop",
      summary:
        "Build typed React features with instant HMR and prewired API forwarding.",
    ...
    },
    {
      title: "Preview",
      summary:
        "Validate typed Express handlers and payload contracts before release.",
  ...
  const foundations = [
    {
      title: "Typed Client Surface",
      detail:
        "React + TypeScript workspace for predictable component evolution.",
      anchor: "client/src/",
    },
    {
      title: "Service Core",
      detail:
        "Express architecture with typed-friendly modules and bounded responsibilities.",
      anchor: "server/src/",
    },
  ];
      ...
      <div className="mx-auto grid w-full max-w-6xl gap-4 px-4 py-6 md:px-8 md:py-10">
        <header className="rounded-xl border border-white/10 bg-[#0b0b0d] p-5 shadow-[0_24px_60px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.04)] md:p-8">
          <p className="font-mono text-[0.72rem] uppercase tracking-[0.24em] text-[#a1a1aa]">
            MERN STACK + TYPESCRIPT + TAILWIND
          </p>
          <h1 className="mt-2 text-[clamp(2rem,5vw,3.35rem)] font-semibold leading-[1.02] tracking-[-0.06em] text-white">
            Type-Safe Full-Stack Foundation
          </h1>
          <p className="mt-3 max-w-[66ch] leading-[1.65] text-[#a1a1aa]">
            A utility-first baseline for teams building typed React and Express
            products with explicit workflows and concise command paths.
          </p>
        </header>
